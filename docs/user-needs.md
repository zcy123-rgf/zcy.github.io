...
The full journey for a tourist using Maple Echoes:
...
- **Gamified progression**: Fragment collection, achievements, and a leaderboard to keep users motivated.
- **Dual-mode flexibility**: Switch between Quick and Deep Explore at any time to match the user’s needs.
...
Photos from the site are stored in `assets/images/field-research/`.
---
